...
__any__ = ['validateNSX', 'createNsxWire']
...
def validateNSX():
    ...
    res = requests.get(nsxUrl, headers=headers,
...
<guestVlanAllowed>false</guestVlanAllowed>
    ...
    res = requests.post(nsxUrl, headers=headers, auth=HTTPBasicAuth(
        user, password), data=xml, verify=False)
